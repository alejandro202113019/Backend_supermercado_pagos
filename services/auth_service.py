...
class AuthService:
    ...
    def _prepare_user_from_doc(self, user_doc: dict) -> User:
    ...
    async def authenticate_user(
        ...
        try:
            ...
            # Preparar user object
            user = self._prepare_user_from_doc(user_doc)
            ...
            import traceback
            traceback.print_exc()
            raise AuthenticationException("Error interno de autenticación")
    ...
    async def register_user(
        ...
        try:
            ...
            import traceback
            traceback.print_exc()
            raise ValidationException("Error interno al registrar usuario")
    ...
    async def change_password(
        ...
        except (ValidationException, AuthenticationException, NotFoundException):
            raise
        except Exception as e:
            print(f"Error en change_password: {e}")
            import traceback
            traceback.print_exc()
            raise ValidationException("Error interno al cambiar contraseña")
    ...
    async def get_current_user(self, user_id: str) -> User:
        ...
        try:
            ...
            return self._prepare_user_from_doc(user_doc)
